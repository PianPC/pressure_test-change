/*
  ...
  gengetopt -C --no-help --no-version -i /home/weaponizing-censors/zmap_multiple_probes/src/zbopt.ggo -F /home/weaponizing-censors/zmap_multiple_probes/src/zbopt 
...
#include "/home/weaponizing-censors/zmap_multiple_probes/src/zbopt.h"

const char *gengetopt_args_info_purpose = "A tool for limiting and deduplicating a list of IP addresses";

const char *gengetopt_args_info_usage = "Usage: zblacklist [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --ignore-input-errors     Don't print invalid entires in the input\n                                  (default false)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignore_input_errors_given = 0 ;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ignore_input_errors_help = gengetopt_args_info_help[7] ;
  args_info->disable_syslog_help = gengetopt_args_info_help[8] ;
  args_info->help_help = gengetopt_args_info_help[10] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ignore_input_errors_given)
    write_into_file(outfile, "ignore-input-errors", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Don't print invalid entires in the input (default false).  */
          else if (strcmp (long_options[option_index].name, "ignore-input-errors") == 0)
          {
          
          
            if (update_arg( 0 , 
                 0 , &(args_info->ignore_input_errors_given),
                &(local_args_info.ignore_input_errors_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "ignore-input-errors", '-',
                additional_error))
              goto failure;
