/*
  ...
  gengetopt -S --no-help --no-version --unamed-opts=FILE -i /home/weaponizing-censors/zmap_multiple_probes/src/topt.ggo -F /home/weaponizing-censors/zmap_multiple_probes/src/topt 
...
#include "/home/weaponizing-censors/zmap_multiple_probes/src/topt.h"

const char *gengetopt_args_info_purpose = "A buffering output splitter";

const char *gengetopt_args_info_usage = "Usage: ztee [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --monitor                 Print monitor data to stderr",
  "  -u, --status-updates-file=monitor.csv\n                                File to write status updates, in CSV format",
  "  -l, --log-file=STRING         File to log errors, etc. to",
  "  -r, --raw                     Ignore input formatting and pass through raw\n                                  input",
  "\nAdditional options:",
  ...
  while (1)
    {
      ...
      switch (c)
        {
        case 'm':	/* Print monitor data to stderr.  */
        ...
        case 'u':	/* File to write status updates, in CSV format.  */
          ...
          break;
        case 'l':	/* File to log errors, etc. to.  */
          ...
          break;
        case 'r':	/* Ignore input formatting and pass through raw input.  */
