...
#define CMDLINE_PARSER_PACKAGE "zblacklist"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "zblacklist"
#endif
...
struct gengetopt_args_info
{
  ...
  const char *no_duplicate_checking_help; /**< @brief Don't deduplicate IP addresses (default false) help description.  */
  ...
  const char *ignore_input_errors_help; /**< @brief Don't print invalid entires in the input (default false) help description.  */
  ...
  unsigned int ignore_input_errors_given ;	/**< @brief Whether ignore-input-errors was given.  */
